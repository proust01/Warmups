...
var getRanddomIndex = function(array) {
...
console.log(getRanddomIndex(thisArray));
console.log(getRanddomIndex(thatArray));

var startUpIdeaCombinaton = [
    thisArray[getRanddomIndex(thisArray)], 
    thisArray[getRanddomIndex(thisArray)], 
    thatArray[getRanddomIndex(thatArray)], 
    thatArray[getRanddomIndex(thatArray)]
];

console.log(startUpIdeaCombinaton);

var btn = document.getElementById("button");

function showResult() {
    var lists = document.getElementById('result');
    for(let i=0; i<startUpIdeaCombinaton.length; i++) {
        var list = document.createElement('li');
        list.innerHTML = startUpIdeaCombinaton[i];
